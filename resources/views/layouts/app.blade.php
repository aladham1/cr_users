            ...
            <div class="bg-white dark:bg-dark h-full">
                <div class="p-3.5">
                    <a href="index.html" class="main-logo w-full">
                        ...
                        <img src="assets/images/logo-light.svg" class="mx-auto light-logo h-8 logo hidden dark:block" alt="logo" />
                ...
                <div class="h-[calc(100vh-93px)] overflow-y-auto overflow-x-hidden space-y-16 px-4 pt-2 pb-4">
                    <ul class="relative flex flex-col gap-1 text-sm" x-data="{ activeMenu: 'pages' }">
                        ...
                        <li class="menu nav-item">
                            <a href="javaScript:;" class="nav-link group items-center justify-between" :class="{'active' : activeMenu === 'social'}" @click="activeMenu === 'social' ? activeMenu = null : activeMenu = 'social'">
                                <div class="flex items-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="w-4 h-4 flex items-center justify-center dropdown-icon" :class="{'!rotate-180' : activeMenu === 'social'}">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-6 h-6">
                                        <path d="M11.9997 13.1714L16.9495 8.22168L18.3637 9.63589L11.9997 15.9999L5.63574 9.63589L7.04996 8.22168L11.9997 13.1714Z" fill="currentColor"></path>
                                    </svg>
                                </div>
                            </a>
                            <ul x-cloak x-show="activeMenu === 'social'" x-collapse class="sub-menu flex flex-col gap-1">
                        ...
                        <li class="menu nav-item">
                            <a href="javaScript:;" class="nav-link group items-center justify-between" :class="{'active' : activeMenu === 'elements'}" @click="activeMenu === 'elements' ? activeMenu = null : activeMenu = 'elements'">
                                <div class="flex items-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="w-4 h-4 flex items-center justify-center dropdown-icon" :class="{'!rotate-180' : activeMenu === 'elements'}">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-6 h-6">
                                        <path d="M11.9997 13.1714L16.9495 8.22168L18.3637 9.63589L11.9997 15.9999L5.63574 9.63589L7.04996 8.22168L11.9997 13.1714Z" fill="currentColor"></path>
                                    </svg>
                                </div>
                            </a>
                            <ul x-cloak x-show="activeMenu === 'elements'" x-collapse class="sub-menu flex flex-col gap-1">
                        ...
                        <li class="menu nav-item">
                            <a href="chart.html" class="nav-link group" :class="{'active' : activeMenu === 'chart'}">
                                <div class="flex items-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="menu nav-item">
                            <a href="font-icons.html" class="nav-link group" :class="{'active' : activeMenu === 'fonticon'}">
                                <div class="flex items-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="menu nav-item">
                            <a href="drag-and-drop.html" class="nav-link group" :class="{'active' : activeMenu === 'dragdrop'}">
                                <div class="flex items-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="menu nav-item">
                            ...
                            <ul x-cloak x-show="activeMenu === 'tabels'" x-collapse class="sub-menu flex flex-col gap-1">
                                ...
                                <li><a href="datatables-basic.html">Data Table</a></li>
                        ...
                        <li class="menu nav-item">
                            ...
                            <ul x-cloak x-show="activeMenu === 'invoice'" x-collapse class="sub-menu flex flex-col gap-1">
                                <li><a href="invoice-create.html">Invoice</a></li>
                                <li><a href="invoice.html">Invoice Add</a></li>
                                <li><a href="invoice-table.html">Invoice List</a></li>
                            </ul>
                        </li>
                        <li class="menu nav-item">
                            <a href="javaScript:;" class="nav-link group items-center justify-between" :class="{'active' : activeMenu === 'userprofile'}" @click="activeMenu === 'userprofile' ? activeMenu = null : activeMenu = 'userprofile'">
                                <div class="flex items-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="w-4 h-4 flex items-center justify-center dropdown-icon" :class="{'!rotate-180' : activeMenu === 'userprofile'}">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-6 h-6">
                                        <path d="M11.9997 13.1714L16.9495 8.22168L18.3637 9.63589L11.9997 15.9999L5.63574 9.63589L7.04996 8.22168L11.9997 13.1714Z" fill="currentColor"></path>
                                    </svg>
                                </div>
                            </a>
                            <ul x-cloak x-show="activeMenu === 'userprofile'" x-collapse class="sub-menu flex flex-col gap-1">
                        ...
                        <li class="menu nav-item">
                            ...
                            <ul x-cloak x-show="activeMenu === 'pages'" x-collapse class="sub-menu flex flex-col gap-1">
                                <li><a href="blank.html" class="active">Starter Page</a></li>
                        ...
                        <li class="menu nav-item">
                            ...
                            <ul x-cloak x-show="activeMenu === 'authentication'" x-collapse class="sub-menu flex flex-col gap-1">
                                ...
                                <li><a href="signin-cover.html">Register Cover</a></li>
                                <li><a href="forgot-pw.html">Reset Id</a></li>
                                <li><a href="forgot-pw-cover.html">Reset Id Cover</a></li>
                                <li><a href="twostep.html">Verification</a></li>
                                <li><a href="twostep-cover.html">Verification Cover</a></li>
                            </ul>
                        </li>
                        <li class="menu nav-item">
                            <a href="changelog.html" class="nav-link group" :class="{'active' : activeMenu === 'changelog'}">
                                <div class="flex items-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
