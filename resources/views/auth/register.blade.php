<x-guest-layout>
    <div class="sm:p-[60px] p-9 border-2 border-gray/10 dark:border-gray/20 bg-white/10 dark:bg-white/[0.02] backdrop-blur-3xl max-w-[620px] mx-auto rounded-lg w-full">
        ...
        <form method="POST" action="{{ route('register') }}" class="mt-[60px] space-y-5">
            @csrf
            <div class="relative">
                <input type="text"
                       name="name" value="{{old('name')}}" required autofocus autocomplete="name"
                       class="form-input h-[66px] bg-transparent dark:bg-transparent text-base rounded-[10px] ps-5 pe-14" placeholder="Full Name">
            ...
            <div class="relative">
                <div class="flex items-stretch gap-5">
                    <select class="form-input h-[66px] bg-transparent dark:bg-transparent text-base rounded-[10px] ps-5 pe-14" name="country" id="country-select">
                        <option value="">Select a country</option>
                    </select>
                    <input type="text" name="phone" class="form-input h-[66px] bg-transparent dark:bg-transparent text-base rounded-[10px] ps-5 pe-14" placeholder="Phone number" required="">
                </div>
                <x-input-error :messages="$errors->get('phone')" class="mt-2" />
            </div>
            <div class="relative">
                <input type="email" name="email" value="{{old('email')}}" class="form-input h-[66px] bg-transparent dark:bg-transparent text-base rounded-[10px] ps-5 pe-14" placeholder="Email ID">
                <span class="text-primary absolute right-5 top-1/2 -translate-y-1/2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="!mt-[50px]">
                <button class="btn bg-primary py-6 uppercase tracking-widest font-bold text-sm rounded-[10px] text-white w-full hover:bg-primary/90 duration-300">
                    Create account
                </button>
            </div>
        </form>
    ...
    <script>
        // Assuming your JSON data is stored in a variable called 'countries'
        var countries = [
            {
                "name": "Afghanistan",
                "dial_code": "+93",
        ...
        // Loop through the countries and create an option for each one
