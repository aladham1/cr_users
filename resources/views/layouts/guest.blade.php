    ...
    <div class="relative">
        <div class="md:p-10 p-6 flex items-center justify-center sm:justify-between w-full flex-wrap gap-5">
            <a href="index.html" class="main-logo">
                <img src="{{asset('assets/images/logo-dark.svg')}}" class="dark-logo h-8 logo dark:hidden" alt="logo"/>
            ...
            <div class="flex items-center gap-5">
                ...
                <p>Already have an account? <a href="{{route('login')}}"
                                               class="font-semibold underline underline-offset-4 text-success">Login</a>
                </p>
            </div>
        </div>
